...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<DoctorData>(create:(context) => DoctorData()),
        ChangeNotifierProvider<PatientData>(create:(context) => PatientData()),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
        ...
        home: SelectAccountScreen(), //PatientDetailsScreen(),
      ),
    );
  }
}
