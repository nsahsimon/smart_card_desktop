...
import '../patient_screens/patient_login.dart';
                        ...
                        children: [
                          ...
                          RoundedButton(
                            ...
                            onTap: () async{
                              startLoading;
                              try {
                                if(!await UserAuthentication(context).doctorLogin(username: _usernameController.text, pinCode: _pinCodeController.text)) {
                              debugPrint("doctor Login failed");
                              return;
                              }
                                bool result = await Navigator.push(context, MaterialPageRoute(builder: (context) => PatientLoginScreen(fromDoctor: true)));
                                if(result == null || result == false) {
                                  return ;
                                } else {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => PatientDetailsScreen(isPatient: false)));
                                }
